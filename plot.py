...
ax1.plot(Hopf_data[:,0], Hopf_data[:,1], linewidth=1, label='$X_1$')
ax1.plot(Hopf_simulation[:,0], Hopf_simulation[:,1], '--', linewidth=1)
# ax1.legend(loc=3)
ax1.set_xlabel('t')
ax1.set_ylabel('$X_2$')
# ax1.set_xticks([])
...
ax2.plot(Hopf_data[:,0], Hopf_data[:,2], linewidth=1, label='$X_2$')
ax2.plot(Hopf_simulation[:,0], Hopf_simulation[:,2], '--', linewidth=1)
# ax2.legend(loc=3)
ax2.set_xlabel('t')
ax2.set_ylabel('$X_1$')
# ax2.set_xticks([])
...
ax3.plot(Hopf_data[:,0], Hopf_data[:,3], linewidth=1, label=r'$\bar{\sigma}$')
ax3.plot(Hopf_simulation[:,0], Hopf_simulation[:,3], '--', linewidth=1)
# ax3.legend(loc=3)
ax3.set_xlabel('t')
